...
import UploadImage from './our-image-uploaded';
import Editor from './editor';
import { About, AboutImage, OurHistory, OurHistoryImage } from '@prisma/client';
...
interface AboutUsSectionProps {
    initialData?: OurHistory & { images: OurHistoryImage[] };
    images?: string[]
}

export default function OurHistorySection({ initialData, images }: AboutUsSectionProps) {
    ...
    const sendImages = async () => {
        ...
        setLoading(true);
        try {
            await axios.patch('/api/our-history', {
                imageUrls,
            });
